...
3. Please follow the coding style guidelines and maintain consistency with the existing ECHO CORP codebase. For reference, the original Betaflight style guide: https://github.com/betaflight/betaflight/blob/master/docs/development/CodingStyle.md
